...
HISTORY:
	2024-07-19 ( danshockley ): Minor update to script description, making clear that this uses a NOT EXACT comparison, instead of the case-insensitive inequality operator (actual change was years ago in 3.9.2). 
